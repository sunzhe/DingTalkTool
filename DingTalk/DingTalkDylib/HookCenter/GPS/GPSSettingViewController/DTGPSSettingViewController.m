...
@interface DTGPSSettingViewController () <MKMapViewDelegate> {
    ...
    CLLocationCoordinate2D curr_coordinate;
}
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *clear = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemUndo target:self action:@selector(clearLocationSetting:)];
    UIBarButtonItem *save = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(commit:)];
...
-(void)mapView:(MKMapView *)mapView didUpdateUserLocation:(MKUserLocation *)userLocation {
    ...
    if(curr_coordinate.latitude == 0 && curr_coordinate.longitude == 0) {
